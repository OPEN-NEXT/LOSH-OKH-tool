...
//     static LOG_FILE_NAME: Lazy<String> = Lazy::new(|| {
//         format!("{}.log.txt", crate_name!())
//     });
...
static ARGS: Lazy<[Arg<'static>; 0]> = Lazy::new(|| {
    [
        // arg_project_root(),
        // arg_variable(),
        // arg_variables_file(),
...
// static SUBS: Lazy<[App<'static>; 2]> = Lazy::new(|| {
//     [
//         subcom_convert(),
//         subcom_validate(),
//     ]
